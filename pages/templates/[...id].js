          ...
          <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-3">
            <div className="lg:block fixed top-36">
              ...
              >
                <Avatar className="my-4" size="large">
                  <AvatarImage
                    src={templateInfo?.user.image}
                    alt={templateInfo?.user.name}
                  />
                </Avatar>
              ...
              <div className="flex gap-3 justify-center text-center mt-6">
                <a
                  href={templateInfo?.repositoryLink}
                  target="_blank"
                  style={{ width: "10rem" }}
                >
                ...
                <a
                  href={templateInfo?.deployedLink}
                  target="_blank"
                  style={{ width: "10rem" }}
                >
            ...
            <div className="col-span-2 border-l border-gray-300 sm:ml-[400px] w-full">
              <div className="px-8">
                ...
                <div
                  className="id_details"
                  dangerouslySetInnerHTML={{
                    __html: templateInfo?.description,
                  }}
                />
              </div>
            </div>
